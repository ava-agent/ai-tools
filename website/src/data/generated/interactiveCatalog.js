// Generated from src/data/tools.js. Run npm run generate:data after catalog edits.
export const interactiveCatalog = [
  {
    "id": "cursor",
    "name": "Cursor",
    "developer": "Anysphere",
  ...
  },
  {
    ...
    "freeQuota": "Free：5,000 次/月 Autocompletion、有限 Basic usage，云任务并发和模型访问按当前计划表限制",
    "contextWindow": "取决于模型",
  ...
  },
  {
    ...
    "freeQuota": "Community Edition 免费；新用户 14 天 Pro Trial 含 300 credits、无限 Completions & Next Edits、Chat Ask & Agent、Quest、Repo Wiki、Knowledge Card",
  ...
  },
  {
    ...
    "freeQuota": "标准版：100 notebooks、每个 notebook 50 sources、每个 source 500,000 words；每日 50 chat queries、3 audio generations，并在升级表中列出 Video Overviews / Deep Research 等额外限额",
    "contextWindow": "N/A",
  ...
  },
  {
    ...
    "freeQuota": "Basic/Free $0 展示 80 monthly video credits；Standard 700、Pro 2,300、Fancy 6,000；不同功能按 10/20/60/80 credits per video 等规则消耗",
    "contextWindow": "N/A",
  ...
  },
  {
    ...
    "freeQuota": "免费计划每周含 10 积分；付费计划的优先积分和慢速积分额度因套餐而异",
    "contextWindow": "N/A",
  ...
  },
  {
    ...
    "freeQuota": "Free plan 50 credits 每日刷新，约 10 songs per day；Free/Basic 生成歌曲仅限个人非商业用途",
    "contextWindow": "N/A",
  ...
  },
  {
    ...
    "freeQuota": "各计划包含月度 credits；生成成本按模型和输出规格变化，pricing 页列出 Ray3、Photon、Seedance、Kling、Veo、GPT Image、Nano Banana Pro 等模型成本",
    "contextWindow": "N/A",
