...
export const homeCatalog = [
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 3,
      "insights": "截至 2026-07-13，GitHub 官方 plans/docs 列出 Free、Pro、Pro+、Max、Busi"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4,
      "insights": "截至 2026-07-12，ElevenLabs 官方模型文档列出 Eleven v3、Multilingual v2、"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4.5,
      "insights": "MCP Core 核心工具之一。它的优势是把浏览器交互转成结构化快照和工具调用，适合让 AI 在真实页面里做回归验证、交"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4,
      "insights": "比简单 fetch 更适合深度抓取和 RAG 数据准备。当前价格已经从旧的固定免费次数表述变化为 credits 体系，"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4.5,
      "insights": "MCP Core 核心工具之一。GitHub 官方 server 的价值在于把 repo、Issue、PR、Action"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4,
      "insights": "截至 2026-07-13，Figma MCP 远程端点覆盖所有 seat/plan，但 View/Collab 只有最"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4,
      "insights": "当前核验环境存在精确 frontend-app-builder Skill。它适合作为旧页面现代化入口，但价值在于把设计"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4,
      "insights": "这个条目应从“自动生成测试用例”调整为“真实浏览器验证工作流”。它的价值在于把页面身份、空白页、错误 overlay、控"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 3.5,
      "insights": "当前核验环境存在精确 building-mcp-server-on-cloudflare Skill。推荐时应把它写成 "
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4,
      "insights": "这个条目有明确安装环境来源：skill-creator 指导从示例理解、资源规划、init_skill.py 初始化、S"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4,
      "insights": "Semgrep 的公开 semgrep/skills 仓库已经能核验 semgrep Skill 上游存在；实际扫描能力"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 3.5,
      "insights": "Trail of Bits 的公开插件仓库已能核验 differential-review Skill 上游存在；它更像"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4,
      "insights": "当前不能把它写成独立 Realtime 专家 Skill；更准确的是 Supabase Skill 的一个子场景和历史别"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 2.5,
      "insights": "这是典型的“自研想法遗留项”：没有安装环境 Skill 或数据源证据时，应先弃用公开推荐，只保留为后续补模板和数据接入的"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 2.5,
      "insights": "没有同名来源时，“think-harder”不应作为产品化 Skill 展示。更好的目录体验是把用户导向具体流程：需求设"
    },
    "decisionSummary": {
  ...
  },
  {
    ...
    "personalExperience": {
      "rating": 4.5,
      "insights": "research 现在应拆成两层：Product Design 的 research 负责当前用户痛点和体验摩擦；Any"
    },
    "decisionSummary": {
