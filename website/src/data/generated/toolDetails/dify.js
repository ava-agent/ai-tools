...
export default {
  ...
  "personalExperience": {
    "rating": 4,
    "insights": "截至 2026-07-07，Dify 的价值不只是“可自托管”，而是把 RAG、Workflow、Agent、插件和观测做成一套产品化工作台。当前 pricing 页默认展示 Professional $590/year、Team $1590/year 与 Sandbox Free 200 message credits；选型时应把 Cloud workspace 额度、annual/monthly billing 和 Community Edition 的运维成本分开算。",
    "pitfalls": [
      "Cloud 额度不是无限",
      "自托管仍要承担模型和基础设施成本",
      "企业数据权限和日志留存需要单独设计"
