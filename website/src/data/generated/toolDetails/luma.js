...
export default {
  ...
  "versions": [
    {
      ...
      "models": "UNI-1/UNI-1.1、Ray3、Ray3.2、Ray3.14、Photon、Luma Agents，以及 Seedance、Kling、Veo、GPT Image、Nano Banana Pro 等第三方模型",
  ...
  "decisionSummary": {
    "verdict": "适合创意团队用 Luma Agents、Ray3 和 Photon 做视频/图像工作流；预算要按计划、API 用量和模型成本分开算。",
    "bestFor": "高质量短视频生成、产品展示视频、创意团队视频工作流",
