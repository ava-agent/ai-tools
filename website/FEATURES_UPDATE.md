...
> 当前维护说明（2026-06-26）：本文最初记录 2026-02-04 的功能新增，是历史快照。当前站点已扩展为 125 个工具、7 个类别、6 套工作流；运行和验证以当前源码、README 与 TROUBLESHOOTING 为准。
...
| 页面 | 路径 | 数据文件 | 功能描述 |
|------|------|----------|----------|
| 首页 | `/` | recommendations.js, tools.js | Landing 和推荐入口 |
| 工具列表 | `/tools` | tools.js | 展示所有 AI 工具 |
